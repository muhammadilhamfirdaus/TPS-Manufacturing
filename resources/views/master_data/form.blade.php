                        ...
                        <div class="card shadow-sm border-0 rounded-4 mb-4">
                            <div class="card-body p-4">
                                <h6 class="fw-bold text-dark mb-3"><i
                                        class="fas fa-sliders-h text-warning me-2"></i>Spesifikasi Produksi</h6>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                            ...
                                            @if(isset($product) && $product->routings->count() > 0)
                                                @foreach($product->routings as $index => $route)
                                                    <tr>
                                                        ...
                                                        {{-- 1. PLANT (Perhatikan atribut data-selected) --}}
                                                        <td>
                                                        ...
                                                        {{-- 2. LINE (Perhatikan atribut data-selected) --}}
                                                        <td>
                                                            <select name="routings[{{ $index }}][production_line_id]"
                                                                ...
                                                                {{-- Opsi akan diisi otomatis oleh JS saat load, tapi kita render
                                                                nilai sekarang biar aman --}}
                                                                <option value="{{ $route->production_line_id }}" selected>
                                                                    {{ $route->productionLine->name ?? 'Loading...' }}
                                                                </option>
                                                            </select>
                                                        </td>

                                                        {{-- 3. MESIN (Perhatikan atribut data-selected) --}}
                                                        <td>
                                                            <select name="routings[{{ $index }}][machine_id]"
                                                                ...
                                                                <option value="{{ $route->machine_id }}" selected>
                                                                    {{ $route->machine->name ?? 'Loading...' }}
                                                                </option>
                                                            </select>
                                                        </td>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.querySelectorAll('#routingBody tr').forEach(row => {
                // Kita perlu memicu filter ulang agar dropdown terisi opsi lain yang valid
                // Tapi kita harus simpan dulu nilai yang terpilih saat ini
